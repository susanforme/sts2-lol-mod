...
| 1 | `JHIN-DANCING_GRENADE` | 曼舞手雷 | Dancing Grenade | 攻击 | `2` | 稀有 | 随机敌人 | `src/cards/DancingGrenade.cs` | 随机命中 1 名敌人后最多弹跳 4 次；每次弹跳都会提高伤害，击杀时还会让下一跳额外增伤。 |
...
**高对比、强动作、剪影清晰、漫画化奇幻战斗插画。**

卡面设计语言重点如下：

### 1. 构图：瞬间动作定格

卡面通常不是“角色站姿展示”，而是一个**攻击、格挡、冲刺、爆炸、法术释放的瞬间**。
...
- 敌人或目标只露出局部，用来强调打击感
- 大量使用斜线、弧线、冲击波制造运动方向
- 画面中心往往不是人物脸，而是“动作结果”：刀光、拳头、爆炸、法术轨迹
...
它不是精细厚涂，而是**游戏图标级插画**：小尺寸下也要一眼看懂发生了什么。

### 3. 色彩：强烈互补色和局部高饱和

每张图通常有一个主色氛围，比如红、紫、蓝、绿、橙，然后用强对比色制造视觉焦点。
...
阴影常用大块黑色或深色压住，不追求真实体积，而是为了让动作和特效更醒目。
...
- 抽象速度线
- 烟尘、裂地、光束
- 少量环境暗示，如星空、地面、洞穴、竞技场

背景的作用主要是强化情绪和方向感，而不是讲完整场景。
...
- 虚弱：人物被压制、紫色或灰暗氛围
- 多段攻击：重复刀影、多个飞刃
- 星界 / 魔法：蓝紫星空、弧形能量、发光符号

也就是说，画面不只是“好看”，而是要让玩家瞬间理解这张卡的功能。

### 之后生成类似卡面时，我会遵循的风格规则

我会把重点放在：

**小画幅可读性、夸张动作、粗轮廓、强对比色、漫画式特效、抽象战斗背景、明确技能动词。**
...
可以理解为：
**暗黑奇幻 roguelike 卡牌插画 + 美漫动作分镜 + 高饱和技能图标语言。**
